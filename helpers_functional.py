...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  9 15:01:56 2025
...
def nicheOverlapSaveTimeSeriesMultipleChooseTime(wt,mut,s1,s2,s1_conc=0.1,s2_conc=0.01,max_cyc=240):
    ...
    # create an empty layout
        ...
        # Add typical trace metabolites and oxygen coli as static
        trace_metabolites = ['ca2_e', 'cl_e', 'cobalt2_e', 'cu2_e', 'fe2_e', 'fe3_e', 'h_e', 'k_e', 'h2o_e', 'mg2_e',
                             'mn2_e', 'mobd_e', 'na1_e', 'o2_e', 'ni2_e', 'nh4_e', 'pi_e', 'so4_e', 'zn2_e', 'ala__L_e', 
                             'arg__L_e', 'asn__L_e', 'asp__L_e', 'cys__L_e', 'gln__L_e','glu__L_e', 'gly_e', 'his__L_e',
                             'ile__L_e', 'leu__L_e', 'lys__L_e', 'met__L_e', 'phe__L_e', 'pro__L_e', 'ser__L_e', 
                             'thr__L_e', 'trp__L_e', 'tyr__L_e', 'val__L_e', 'thm_e', 'ribflv_e', 'btn_e', 'pnto__R_e', 
                             'fol_e', 'co2_e', 'nac_e']
