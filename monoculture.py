...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  2 17:13:46 2023
...
wt = c.model(load_model("iJO1366"))
ec = c.model(read_sbml_model('ecoli_k12_mg1655.xml'))
bs = c.model(read_sbml_model('bacillus_subtilis.xml'))
wt.id = 'wt'
ec.id = 'ecoli'
X = -10 
wt.change_bounds('EX_succ_e', -20,1000)
wt.change_bounds('EX_glc__D_e',X,1000)

ec.change_bounds('EX_succ_e', -20,1000)
ec.change_bounds('EX_glc__D_e',X,1000)

#wt.change_bounds('EX_lac__D_e',-20,1000)
#wt.add_neutral_drift_parameter(0.05)
#wt.change_bounds('EX_ac_e', -20,1000)

#bs = c.model(load_model("iYO844"))
bs.id = 'bsubtilis'
bs.change_bounds('EX_succ_e', -X,1000)
bs.change_bounds('EX_glc__D_e',-20,1000)
mut = c.model(load_model("iJO1366"))
mut.id = 'mut'
mut.change_bounds('EX_succ_e', -X,1000)
mut.change_bounds('EX_glc__D_e',-20,1000)
#mut.change_bounds('EX_ac_e', -20,1000)
#mut.add_neutral_drift_parameter(0.05)
